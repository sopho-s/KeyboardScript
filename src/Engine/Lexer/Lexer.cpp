...
namespace Engine {
    namespace Lexer {
        enum Objects::TokenType idents[30] = {Objects::semi, Objects::openbracket, Objects::closebracket, Objects::cclosebracket, Objects::copenbracket, Objects::add, Objects::sub, Objects::mul, Objects::div, Objects::assign, Objects::point, Objects::comma, Objects::greater, Objects::lesser, Objects::mod, Objects::sopenbracket, Objects::sclosebracket, Objects::_return, Objects::func, Objects::_if, Objects::_and, Objects::_or, Objects::_not, Objects::_for, Objects::_while, Objects::_class, Objects::_else, Objects::___try, Objects::_bool, Objects::_bool};
        char identschar[17] = {';', '(', ')', '}', '{', '+', '-', '*', '/', '=', '.', ',', '>', '<', '%', '[', ']'};
